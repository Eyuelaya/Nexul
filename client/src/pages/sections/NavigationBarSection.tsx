...
export const NavigationBarSection = (): JSX.Element => {
  return (
    <nav className=" w-full h-[91px] absolute top-0 left-0 z-50 bg-transparent ">
      <div className="absolute top-[44px] left-[317px] w-[1081px] h-14 bg-[#5d5d5b] rounded-[31px] backdrop-blur-[6.3px] backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(6.3px)_brightness(100%)] opacity-[0.49]" />
      ...
      <img
        className="absolute top-5 left-[76px] w-[200px] h-[69px]"
        alt="Union"
        src="/figmaAssets/union-1.svg"
      />
       <a href="#H">
       <div className="absolute top-[51px] left-[76px] w-[164px] h-[60px]">
          <img
