        ...
        {formFields.map((row, rowIndex) => (
          ...
          >
            {row.fields.map((field, fieldIndex) => (
              ...
              >
                <Label className="flex items-center gap-0.5 [font-family:'Arial-Regular',Helvetica] font-normal text-[#f9f9f9] text-sm tracking-[0] leading-[14px]">
                  {field.label}
                  {field.required && (
                ...
                <div className="relative">
                  <Input
                    ...
                    className={`h-9 bg-[#2626264c] rounded-lg border-[0.8px] border-solid border-neutral-800 [font-family:'Arial-Regular',Helvetica] font-normal text-[#a0a0a0] text-sm tracking-[0] leading-[normal] ${
